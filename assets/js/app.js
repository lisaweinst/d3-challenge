...
function updateToolTip(currentXAxis, currentYAxis, circlesGroup) {
    ...
    var toolTip = d3.tip()
        ...
        .offset([-8, 0])
        .html(function(d) {
            return (`${d.state}<br>${xLabel} ${styleX(d[currentXAxis], currentXAxis)}<br>${yLabel} ${d[currentYAxis]}%`);
        });
...
d3.csv("./assets/data/data.csv").then(function(censusData) {
    ...
    var circlesGroup = updateToolTip(currentXAxis, currentYAxis, circlesGroup);
